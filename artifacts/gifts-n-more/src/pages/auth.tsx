...
function handleGoogleSignIn() {
  // Redirect to Google OAuth endpoint on the API server.
  // The API server will handle the OAuth flow and redirect back with a token.
      ...
      <section className="flex min-h-screen items-center justify-center bg-background py-20">
        <div className="w-full max-w-md border border-border bg-card p-8 shadow-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 border border-border bg-background px-4 py-3 text-sm font-medium transition-all hover:border-primary/50 hover:bg-primary/5"
          >
            <GoogleIcon />
